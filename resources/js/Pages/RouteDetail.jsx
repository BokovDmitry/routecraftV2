        ...
        <>
                ...
                >
                    ...
                    <div className="hero-content px-3">
                        ...
                        <p className="hero-description py-1">
                            This is the individual route page where you can see
                            full details, like the route, and check out user
                            reviews.
                        </p>
                    </div>
                </div>
            ...
            <main>
                <Container className="py-5">
                    ...
                    <Row className="mt-4">
                        <Col>
                            <p className="route-description-full">
                                {description}
                            </p>
                        </Col>
                    </Row>
                        ...
                        <>
                            ...
                            <Row className="daily-stops-row">
                                {parsedPlaces.map((day, dayIndex) => {
                                    const validPlaces = Array.isArray(
                                        day.places
                                    )
                                        ? day.places.filter(
                                              (place) => place.trim() !== ""
