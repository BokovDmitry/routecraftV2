...
export default function EditRouteForm({ existingRoute }) {
    ...
    const [imagePreview, setImagePreview] = useState(existingRoute.image ? `/storage/${existingRoute.image}` : null);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`/routes/${existingRoute.id}/update`, formDataToSend, {
                headers: {
            ...
            <Container>
                ...
                <Form onSubmit={handleSubmit} className="route-form">
                    ...
                    <Row className="mb-4">
                        <Col md={6}>
                            <Form.Group>
                                ...
                                <Form.Control type="text" name="destination_country" value={formData.destination_country} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col md={6}>
                            <Form.Group>
                                <Form.Label>City</Form.Label>
                                <Form.Control type="text" name="destination_city" value={formData.destination_city} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                    </Row>
                    ...
                    <Form.Group className="mb-4">
                        ...
                        <Form.Control as="textarea" name="description" rows={4} value={formData.description} onChange={handleChange} />
                    </Form.Group>
                    ...
                    <Row className="mb-4">
                        <Col md={6}>
                            <Form.Group>
                                ...
                                <Form.Control type="number" name="budget" value={formData.budget} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                        <Col md={6}>
                            <Form.Group>
                                <Form.Label>Days</Form.Label>
                                <Form.Control type="number" name="days" value={formData.days} onChange={handleChange} readOnly />
                            </Form.Group>
                        </Col>
                    </Row>
  ...
  <Col key={dayIndex} md={4} className="mb-4">
    <div className="day-card p-3">
      ...
      <div className="added-places mt-3">
        {day.places
          .filter((p, i) => i !== day.places.length - 1 && p.trim() !== '')
          .map((place, index) => (
